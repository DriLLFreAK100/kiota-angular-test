 ...
 */
// @ts-ignore
export function serializeInventoryGetResponse(writer: SerializationWriter, inventoryGetResponse: Partial<InventoryGetResponse> | undefined | null = {}) : void {
    if (inventoryGetResponse) {
