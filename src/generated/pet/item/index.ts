 ...
 */
// @ts-ignore
export function serializeWithPetPostRequestBody(writer: SerializationWriter, withPetPostRequestBody: Partial<WithPetPostRequestBody> | undefined | null = {}) : void {
    if (withPetPostRequestBody) {
